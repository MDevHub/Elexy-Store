...
import prod12img from '../../assets/images/product-7.png'
		...
		<div>
			<div>
				<div className='pt-10 md:pt-14 pb-10 md:pb-14 px-5 bg-[#f3f3f3]'>
					<h1 className='font-bold text-3xl md:text-4xl mb-5'>Accessories</h1>
					<Link to="/" className="hover:text-gray-500 underline ">Home</Link>
					<span className='ml-3'><Link to="/homeappliances" className="hover:text-gray-500">/ Accessories</Link></span>
				</div>
