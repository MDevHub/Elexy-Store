...
const products = [
  { id: 1, name: 'CCTV Solutions', price: 780000, oldPrice: 1480000, img: prod10img },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {products.map((product) => (
            ...
            >
              ...
              <div className="py-5 pl-5 border-b border-x border-b-[#ffffff] shadow-5xl rounded-b-xl">
                <p className="text-xl font-bold mb-2">{product.name}</p>
                <p className="text-[16px] mr-2 text-[#121212e3]">TK ${product.price.toLocaleString()}</p>
