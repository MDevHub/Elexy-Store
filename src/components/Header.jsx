    ...
    <div className="w-full max-w-screen">
      ...
      >
        ...
        <ul className="flex flex-col gap-5 pt-5 font-[500] text-[#121212bf]">
          <li className="pl-6"><Link to="/" className="text-lg" onClick={() => setMobileOpen(false)}>Home</Link></li>
          <hr className="border bg-[#ffffffce]" />
          <li className="pl-6"><Link to="/shop" className="text-lg" onClick={() => setMobileOpen(false)}>Shop</Link></li>
          <hr className="border bg-[#ffffffce]" />
          <li className="pl-6"><Link to="/products" className="text-lg" onClick={() => setMobileOpen(false)}>Products</Link></li>
          <hr className="border bg-[#ffffffce]" />
          <li className="pl-6"><Link to="/contact" className="text-lg" onClick={() => setMobileOpen(false)}>Contact</Link></li>
          <hr className="border bg-[#ffffffce]" />
			 <li className="pl-6"><Link to="/contact" className="text-lg" onClick={() => setMobileOpen(false)}><FiUser className="inline"/> Login</Link></li>
          <hr className="border bg-[#ffffffce]" />
        </ul>
      </div>
    </div>
